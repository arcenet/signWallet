...
public class SignaturePad extends View {
    ...
    private List<TimedPoint> xPoints;
    public Float pressurePoint;
    public ArrayList<Float> pressurePoints = new ArrayList<Float>();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        pressurePoint = event.getAxisValue(MotionEvent.AXIS_PRESSURE);
        ...
        //Log.e("TILT:", String.valueOf(event.getAxisValue(MotionEvent.AXIS_PRESSURE)));
    ...
    public List<TimedPoint> getxPoints(){
        return xPoints;
    }

    public List<TimedPoint> getmPointsCache(){
        return mPointsCache;
    }
